...
namespace db {
    ...
    public partial class testDataSet1 : global::System.Data.DataSet {
        ...
        public partial class contactsDataTable : global::System.Data.TypedTableBase<contactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public contactsRow AddcontactsRow(string name, int phone, string email, string Пол, string Должность) {
        ...
        public partial class contactsRow : global::System.Data.DataRow {
            ...
            public string Пол {
                get {
                    try {
                        return ((string)(this[this.tablecontacts.ПолColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Пол\' в таблице \'contacts\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tablecontacts.ПолColumn] = value;
                }
            }
            ...
            public string Должность {
                get {
                    try {
                        return ((string)(this[this.tablecontacts.ДолжностьColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Должность\' в таблице \'contacts\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tablecontacts.ДолжностьColumn] = value;
                }
            }
            ...
            public bool IsПолNull() {
                return this.IsNull(this.tablecontacts.ПолColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetПолNull() {
                this[this.tablecontacts.ПолColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsДолжностьNull() {
                return this.IsNull(this.tablecontacts.ДолжностьColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetДолжностьNull() {
                this[this.tablecontacts.ДолжностьColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace db.testDataSet1TableAdapters {
    ...
    public partial class contactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `contacts` WHERE ((`dd` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? = 1 AND `Пол` IS NULL) OR (`Пол` = ?)) AND ((? = 1 AND `Должность` IS NULL) OR (`Должность` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `contacts` (`name`, `phone`, `email`, `Пол`, `Должность`) VALUES (?, " +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `contacts` SET `name` = ?, `phone` = ?, `email` = ?, `Пол` = ?, `Должность` = ? WHERE ((`dd` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` = ?)) AND ((? = 1 AND `Пол` IS NULL) OR (`Пол` = ?)) AND ((? = 1 AND `Должность` IS NULL) OR (`Должность` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT dd, name, phone, email, Пол, Должность FROM contacts";
        ...
        public virtual int Fill(testDataSet1.contactsDataTable dataTable) {
        ...
        public virtual testDataSet1.contactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            testDataSet1.contactsDataTable dataTable = new testDataSet1.contactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(testDataSet1.contactsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_dd, string Original_name, global::System.Nullable<int> Original_phone, string Original_email, string Original_Пол, string Original_Должность) {
        ...
        public virtual int Insert(string name, global::System.Nullable<int> phone, string email, string Пол, string Должность) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, global::System.Nullable<int> phone, string email, string Пол, string Должность, int Original_dd, string Original_name, global::System.Nullable<int> Original_phone, string Original_email, string Original_Пол, string Original_Должность) {
            if ((name == null)) {
